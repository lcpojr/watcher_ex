defmodule Authenticator do
  ...
  alias Authenticator.SignIn.Commands.{
    AuthorizationCode,
    ClientCredentials,
    RefreshToken,
    ResourceOwner
  ...
  @doc "Delegates to #{AuthorizationCode}.execute/1"
  defdelegate sign_in_authorization_code(input), to: AuthorizationCode, as: :execute
