...
```sh
curl -X POST https://watcherex.gigalixirapp.com/admin/v1/sessions/self/logout-all-sessions \
    -H "Content-Type: application/json" \
...
```sh
curl -X POST https://watcherex.gigalixirapp.com/admin/v1/sessions/self/logout \
    -H "Content-Type: application/json" \
