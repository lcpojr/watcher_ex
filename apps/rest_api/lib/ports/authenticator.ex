defmodule RestAPI.Ports.Authenticator do
  ...
  @doc "Authenticates the subject using Authorization Code Flow"
  @spec sign_in_authorization_code(input :: map()) :: possible_sign_in_responses()
  def sign_in_authorization_code(input), do: implementation().sign_in_authorization_code(input)
